...
### Paper digest — 2026-06-09 · 2 new

#### arXiv cs.RO (2)
- [MAP-VLA: Memory-Augmented Prompting for Vision-Language-Action Model in Robotic Manipulation](https://arxiv.org/abs/2511.09516v1) — *Runhao Li, Wenkai Guo, Zhenyu Wu et al.*
- [Spatial Forcing: Implicit Spatial Representation Alignment for Vision-language-action Model](https://arxiv.org/abs/2510.12276v2) — *Fuhao Li, Wenxuan Song, Han Zhao et al.*
